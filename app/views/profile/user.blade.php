				...
				<div class="row">
					...
					<div class="col-xs-3">
						<div class="btn-group-vertical">
							...
							<a class="btn btn-default " href="/ad/remove/{{$ad->id}}"><span class="glyphicon glyphicon-remove-sign"><span></a>
							@endif
						</div>
					</div>
				</div>
...
<div class="col-xs-12 text-center">{{$userUploads->appends(Request::except('page'))->links()}}</div>
@stop
